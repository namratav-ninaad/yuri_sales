...
abstract class ProductRepository {
  Future<Either<Failure, List<ProductModel>>> fetchProducts({required ProductFilterData data});
...
class ProductRepositoryImpl implements ProductRepository {
  ...
  @override
  Future<Either<Failure, List<ProductModel>>> fetchProducts({required ProductFilterData data}) async {
    try {
